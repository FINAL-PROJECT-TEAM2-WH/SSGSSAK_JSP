...
<div id="container">
	...
	<!-- catevar 스타트 -->
	<%@ include file="catevar_prodVer.jsp"%>
	<!-- catevar 엔드 -->
		...
		<div class="cctg_subtit" id="area_disp_ctg_title">
			<h2>
				<a class="notranslate clickable"
					href="/SSGSSAK/productlist/productList.do?categoryId=${crtCateDto.id}&currentPage=1"> <c:choose>
...
<%-- 										class="clickable ">${mnDto.miniCateName}</a></li> --%>
									...
									<li class=" none_child"><a href="javascript:void(0);"
										data-ilparam-type="dispCtgId" data-ilparam-value="6000208938"
										class="clickable">${mnDto.miniCateName}</a></li>
								</c:forEach>
				...
				<div class="tmpl_itemlist" id="area_itemlist"
										...
										<div class="cunit_prod ">
											...
											<div class="thmb">
												<a
													...
													<img srcset="https://simg.ssgcdn.com/trans.ssg?src=/ui/ssg/img/common/img_ready_500x500.jpg"
					...
					<div class="com_paginate notranslate" style="width: 100%">
						<strong title="현재위치">1</strong> <a href="?"
							onclick="itemLister.changePage(2);return false;">2</a> <a
							href="?" onclick="itemLister.changePage(3);return false;">3</a> <a
							href="?" onclick="itemLister.changePage(4);return false;">4</a> <a
							href="?" onclick="itemLister.changePage(5);return false;">5</a> <a
							href="?" onclick="itemLister.changePage(6);return false;">6</a> <a
							href="?" onclick="itemLister.changePage(7);return false;">7</a> <a
							href="?" onclick="itemLister.changePage(8);return false;">8</a> <a
							href="?" onclick="itemLister.changePage(9);return false;">9</a> <a
							href="?" onclick="itemLister.changePage(10);return false;">10</a>
						<a class="btn_next on" href="?"
							onclick="itemLister.changePage(11);return false;" title="다음"><span
							class="blind">다음</span></a> <a class="btn_last on" href="?"
							onclick="itemLister.changePage(289);return false;" title="마지막"><span
