...
<head>
	...
	<title class="notranslate">
		MY SSG > 정보관리 > 개인정보 제 3자 제공 동의</title>
...
//<![CDATA[
    ...
    var ssg = $.extend(ssg || {}, {
        ...
        title : 'MY SSG &gt; 정보관리 &gt; 개인정보 제 3자 제공 동의'
    });
...
<div id="content" class="content_myssg cmem_ct_myssg">
  <h2 class="cmem_msg_tit"><span>개인정보 제3자 제공 동의</span></h2>
    <!-- [D] 개인정보 제3자 제공 동의 내역이 있는 경우 -->
  <div class="cmem_sec">
  <form id="submitForm">
  <!-- 통합회원/임직원 대상 : 옴니 -->
  
	  <div class="cmem_sec">
	    <div class="cmem_msg_head ty_desc">
	      <h3 class="cmem_msg_subtit">신세계포인트 옴니서비스</h3>
	      <p class="cmem_msg_desc">동의 변경 일자: 2024년 04월 03일</p>
	    </div>
	    <div class="cmem_sec_cont">
	      <ul class="cmem_join_benefit ty_col2">
	        <li>
	          <span class="sp_cmem_signup cmem_ico_emart"></span>
	          <div class="cmem_benefit_txt">
	            <span class="cmem_benefit_name">이마트 온&middot;오프라인 구매내역 확인</span>
	            <p>자주 구매하는 상품을 확인하고<br>FOR YOU 맞춤형 상품 추천까지 &ndash;</p>
	          </div>
	        </li>
	        <li>
	          <span class="sp_cmem_signup cmem_ico_momkids"></span>
	          <div class="cmem_benefit_txt">
	            <span class="cmem_benefit_name">이마트 맘키즈 클럽 혜택</span>
	            <p>옴니 동의 후 맘키즈 클럽 가입하면<br>SSG.COM에서도 혜택이 쓱 –</p>
	          </div>
	        </li>
	      </ul>
	    </div>
	    <div class="cmem_sec_cont">
	      <div class="cmem_terms">
	        <div class="cmem_term_box">
	          <span class="cmem_chk">
	            <input type="checkbox" id="mbrSvcAgreeTypeCd" name="mbrSvcAgreeTypeCd" value="50" >
	            <label for="mbrSvcAgreeTypeCd"><em>(선택)</em> 신세계포인트(이마트&middot;신세계백화점) ↔ SSG.COM 개인정보 제3자 제공 동의</label>
	          </span>
	          <button type="button" class="cmem_btn cmem_btn_gray" onclick="viewPolicy('signup_terms07')"><span>내용보기</span></button>
	        </div>
	      </div>
	    </div>
	    <div class="cmem_btnarea">
	      <button type="button" class="cmem_btn cmem_btn_white" onclick="submitForm('omni', this)"><span>변경하기</span></button>
	    </div>
	  </div>
...
<script type="text/javascript" defer="defer">
    function submitForm(option, el) {
        ...
        if (confirm("저장하시겠습니까?")) {
            $('#submitForm').ajaxSubmit({
                type: "POST",
                url: "/myssg/myinfoMng/saveInfoUtlAgree.ssg",
                dataType: "json",
    ...
    function viewPolicy(site, width, height) {
        var w = width || 780;
        var h = height || 600;
        popupWin("/member/join/privacy.ssg?site=" + site, "privacy_policy", w, h, "yes", "no");
    }
</script>
</div>
		<!-- footer -->
