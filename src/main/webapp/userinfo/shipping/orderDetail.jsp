            ...
            <div class="cmmyssg_user" data-react-tarea-cd="00034_000000001">
                <div class="cmmyssg_user_info">
                    <h2 class="cmmyssg_user_tit" data-react-unit-type="text" data-react-unit-id="" data-react-unit-text='[{"type":"tarea_addt_val","value":"이름"}]'>
                        <a href="http://www.ssg.com/myssg/main.ssg" class="cmmyssg_user_tittx clickable" data-react-tarea-dtl-cd="t00060"><span class="cmmyssg_user_titname">이동영 님</span>의 My SSG</a>
                    </h2>
                </div>
            </div>
            ...
            <ul class="myssg_item_list">
                <li class="myssg_item">
                            <div class="myssg_item_img">
                                <img src="https://sui.ssgcdn.com/ui/ssg/img/myssg/img_7_coupon.png" srcset="https://sui.ssgcdn.com/ui/ssg/img/myssg/img_7_coupon@2x.png 2x" />
                        ...
                        <li class="myssg_item">
                            <div class="myssg_item_img">
                                <img src="https://sui.ssgcdn.com/ui/ssg/img/myssg/img_5_coupon.png" srcset="https://sui.ssgcdn.com/ui/ssg/img/myssg/img_5_coupon@2x.png 2x" />
        ...
        <article class="myssg_box has_bg">
            ...
            <div class="myssg_card myssg_card_has_bg myssg_card_preserve_benefit">
                <div class="myssg_card_content">
                    ...
                    <img src="https://sui.ssgcdn.com/ui/ssg/img/myssg/img_membership_benefit.png" srcset="https://sui.ssgcdn.com/ui/ssg/img/myssg/img_membership_benefit@2x.png 2x" />
                </div>
            </div>
        </article>
...
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/lib/jquery-1.9.1.min.js"></script>
...
<input type="hidden" id="pageName" value="orderInfoDetail" />

<input type="hidden" id="selectClaim" value="" />
<input type="hidden" id="selectedOrdNo" value="" />
<input type="hidden" id="selectedOrdItemSeq" value="" />
<div id="content" class="content_myssg codr_ct_clm">
	...
	<div class="codr_odrdeliv">
					<dl class="codr_odrdeliv_head">
						<dt>
							<span class="codr_odrdeliv_odrdate notranslate">2024.04.15</span> <span
								class="codr_odrdeliv_odrnum"> <em>주문번호</em> 20240415-02F004</span>
						</dt>
						<dd>
							<button type="button" class="codr_btn_odrhide codr_sticky_close"
									name="btnDeleteOrderInfo"
					...
					<div class="codr_acdo_cont">
						<div class="codr_odrdeliv_item ty_btnlst emart"
								name="divShppUnit">
	...
	<strong class="codr_odrdeliv_delivtype">
    <span class="notranslate"><span class="blind">점포명</span>양재점</span>
                        </strong>
...
<div class="ssg-layer-popup codr_lypop codr_lypop_magicpickup" id="codr_lypop_magicpickup" style="cursor: default;" role="document">
</div>
<div class="ssg-layer-popup codr_lypop codr_lypop_ppPickup" id="codr_lypop_ppPickup" style="cursor: default;" role="document">
</div>
<div class="ssg-layer-popup codr_lypop codr_lypop_gift" id="codr_lypop_gift"   style="cursor: default;" role="document">
</div>
<div class="ssg-layer-popup codr_lypop codr_lypop_ssgcon" id="codr_lypop_ssgcon"  style="cursor: default;" role="document">
</div>
<div class="ssg-layer-popup codr_lypop codr_lypop_strpickup" id="codr_lypop_strpickup" role="dialog" style="cursor: default;">
</div>
<div class="ssg-layer-popup codr_lypop codr_lypop_strpickup" id="codr_lypop_mnclserviceinfo" role="dialog" style="cursor: default;">
</div>
						...
						<div class="codr_dvstate_bg">
							...
							<div class="tx_area">
								<div class="tx_state">
											...
											배송완료
										<div class="tx_detail">
													<span>04.16(화) 16:09</span>에
															문 앞에 놓아두었습니다.</div>
											</div>
							</div>
						</div>
						<div class="codr_dvstate_lstwrap">
							<ul class="codr_dvstate_lst ty_nopd ty_nobg ty_step6" role="presentation">
								<li class="start">
									<div class="codr_dvstate_item"><span>결제완료</span></div>
									<div class="ico_dvstate"></div>
								</li>
								<li class="car">
									<div class="codr_dvstate_item"><span>상품준비중</span></div>
									<div class="ico_dvstate"></div>
								</li>
								<li class="car">
									<div class="codr_dvstate_item"><span>점포출발</span></div>
									<div class="ico_dvstate"></div>
								</li>
								<li class="car">
									<div class="codr_dvstate_item"><span>배송중</span></div>
									<div class="ico_dvstate"></div>
								</li>
								<li class="car">
									<div class="codr_dvstate_item"><span>도착예정</span></div>
									<div class="ico_dvstate"></div>
								</li>
								<li class="finish on">
											<span class="blind">현재 배송 상태</span>
											<div class="codr_dvstate_item"><span>배송완료</span></div>
											<div class="ico_dvstate"></div>
										</li>
									</ul>
						</div>
					</div>
				<div class="ssg-layer-popup codr_lypop codr_lypop_shopinfo" id="codr_lypop_shopinfo">
</div>
<!-- 알비백 Notice -->
								<dl class="codr_ip" role="presentation">
		<dt>주문자 정보</dt>
		<dd>
			<span class="codr_ip_tx notranslate">
				<span class="blind">주문자 성함</span><em class="notranslate">동스</em>
				<span class="blind">주문자 전화번호</span> 010-9110-1878</span>
		</dd>
	</dl>
	<dl class="codr_ip" role="presentation">
		<dt>받으시는 분</dt>
		<dd>
			<span class="codr_ip_tx">
				<span class="blind">받으시는 분 성함</span><em>이동영</em>
				<span class="blind">받으시는 분 전화번호</span> 
				010-9110-1878<span class="tx_gray notranslate">
	...
	<dl class="codr_ip" role="presentation">
			...
			<dd>
				<span class="codr_ip_tx">
					<span class="blind">주문자 주소</span>
						<span class="notranslate">
							
					                    [이동영]
					                
					                [06131] 
					                 서울특별시 강남구 강남대로94길83, 역삼생활 307호 (역삼동)</span>
						</span>
			</dd>
		</dl>
		<dl class="codr_ip" role="presentation">
		...
		<dl class="codr_ip" role="presentation">
				...
				<dd>
					<span class="codr_ip_tx">
						<span class="blind">수령방법</span>
						<span class="notranslate">
							문 앞</span>
						</span>
					<span class="codr_ip_tx">
						<span class="notranslate">공동현관 출입방법 </span><span> (2024-04-16까지 조회가능)</span><br>
						<span>※ 입력하신 정보는 배송목적으로만 사용되며, 배송 후 안전하게 폐기됩니다.</span>
					</span>
					</dd>
			</dl>
		<div class="codr_unit">
	...
	<td class="codr_thmb">
		<div class="codr_unit_thmb">
			...
			<a href="http://www.ssg.com/item/itemView.ssg?itemId=1000017659761&siteNo=6001&salestrNo=2022" target="_blank">
								<span class="codr_unit_img">
									<img src="https://sitem.ssgcdn.com/61/97/65/item/1000017659761_i1_80.jpg" srcset="https://sitem.ssgcdn.com/61/97/65/item/1000017659761_i1_160.jpg 2x" alt="상품이미지" onerror="javascript:this.src='https://sui.ssgcdn.com/ui/sd/img/common/noImg_80.gif';this.alt='상품 이미지 준비중입니다.';"/></span>
							</a>
						</div>
	</td>
	<td class="codr_unit_cont">
		<div class="codr_unit_type ty_top">
			...
			<a href="http://www.ssg.com/item/itemView.ssg?itemId=1000017659761&siteNo=6001&salestrNo=2022" target="_blank">
								<span class="codr_unit_name"><span>[피코크] 속이 꽉찬 명란 젓 120g</span></span>
							</a>
						</p>
	...
	<td class="codr_unit_pricewrap">
                <div class="codr_unit_newprice notranslate">
    					<span class="blind">판매가격</span> <em class="ssg_price notranslate">6,980</em> <span class="ssg_tx">원</span>
    					</div>
			...
			<td class="codr_unit_btnarea">
					<a href="javascript:void(0);" class="codr_btn_unit"
							name="btnShowItemComment" data-page-div="itemUnit"
							data-item-cnt="4"
							data-item-id="1000017659761"
							data-uitem-id="00000"
		                    data-ord-no="2024041502F004"
		                    data-ord-item-seq="1"
							data-click-page="orderdtl"
							data-bsell-yn="N">
							리뷰작성
						</a>
					</td>
...
<tr class="codr_unit_area" name="divItemUnit">
	<td class="codr_thmb">
		<div class="codr_unit_thmb">
            <input type="hidden" id="ordItemGrp__ForceShppcstBdnMainCd" value="XX"/>
			<a href="http://www.ssg.com/item/itemView.ssg?itemId=0000009592840&siteNo=6001&salestrNo=2022" target="_blank">
								<span class="codr_unit_img">
									<img src="https://sitem.ssgcdn.com/40/28/59/item/0000009592840_i1_80.jpg" srcset="https://sitem.ssgcdn.com/40/28/59/item/0000009592840_i1_160.jpg 2x" alt="상품이미지" onerror="javascript:this.src='https://sui.ssgcdn.com/ui/sd/img/common/noImg_80.gif';this.alt='상품 이미지 준비중입니다.';"/></span>
							</a>
						</div>
	</td>
	<td class="codr_unit_cont">
		<div class="codr_unit_type ty_top">
				<span class="codr_unit_tyred">신선보장</span>
					</div>
			<p class="codr_unit_tit notranslate">
			<a href="http://www.ssg.com/item/itemView.ssg?itemId=0000009592840&siteNo=6001&salestrNo=2022" target="_blank">
								<span class="codr_unit_name"><span>백오이 (5입/봉)</span></span>
							</a>
						</p>
			<div class="codr_unit_type">
			</div> </td>
	<td class="codr_unit_pricewrap">
                <div class="codr_unit_newprice notranslate">
    					<span class="blind">판매가격</span> <em class="ssg_price notranslate">4,980</em> <span class="ssg_tx">원</span>
    					</div>
                    <span class="codr_unit_line"></span>
    				<span class="codr_unit_count">
						<strong class="blind">상품수량</strong>
...
<tr class="codr_unit_area" name="divItemUnit">
	<td class="codr_thmb">
		<div class="codr_unit_thmb">
            <input type="hidden" id="ordItemGrp__ForceShppcstBdnMainCd" value="XX"/>
			<a href="http://www.ssg.com/item/itemView.ssg?itemId=1000030721032&siteNo=6001&salestrNo=2022" target="_blank">
								<span class="codr_unit_img">
									<img src="https://sitem.ssgcdn.com/32/10/72/item/1000030721032_i1_80.jpg" srcset="https://sitem.ssgcdn.com/32/10/72/item/1000030721032_i1_160.jpg 2x" alt="상품이미지" onerror="javascript:this.src='https://sui.ssgcdn.com/ui/sd/img/common/noImg_80.gif';this.alt='상품 이미지 준비중입니다.';"/></span>
							</a>
						</div>
	</td>
	<td class="codr_unit_cont">
		<div class="codr_unit_type ty_top">
			...
			<p class="codr_unit_tit notranslate">
			<a href="http://www.ssg.com/item/itemView.ssg?itemId=1000030721032&siteNo=6001&salestrNo=2022" target="_blank">
								<span class="codr_unit_name"><span>샘표 계란이 맛있어지는 간장 200ml</span></span>
							</a>
						</p>
			<div class="codr_unit_type">
			</div> </td>
	<td class="codr_unit_pricewrap">
                <div class="codr_unit_newprice notranslate">
    					<span class="blind">판매가격</span> <em class="ssg_price notranslate">4,860</em> <span class="ssg_tx">원</span>
    					</div>
                    <span class="codr_unit_line"></span>
    				<span class="codr_unit_count">
						<strong class="blind">상품수량</strong>
...
<tr class="codr_unit_area" name="divItemUnit">
	<td class="codr_thmb">
		<div class="codr_unit_thmb">
            <input type="hidden" id="ordItemGrp__ForceShppcstBdnMainCd" value="XX"/>
			<a href="http://www.ssg.com/item/itemView.ssg?itemId=0000007452331&siteNo=6001&salestrNo=2022" target="_blank">
								<span class="codr_unit_img">
									<img src="https://sitem.ssgcdn.com/31/23/45/item/0000007452331_i1_80.jpg" srcset="https://sitem.ssgcdn.com/31/23/45/item/0000007452331_i1_160.jpg 2x" alt="상품이미지" onerror="javascript:this.src='https://sui.ssgcdn.com/ui/sd/img/common/noImg_80.gif';this.alt='상품 이미지 준비중입니다.';"/></span>
							</a>
						</div>
	</td>
	<td class="codr_unit_cont">
		<div class="codr_unit_type ty_top">
			...
			<p class="codr_unit_tit notranslate">
			<a href="http://www.ssg.com/item/itemView.ssg?itemId=0000007452331&siteNo=6001&salestrNo=2022" target="_blank">
								<span class="codr_unit_name"><span>[풀무원] SOGA 부드러운 찌개두부 300g</span></span>
							</a>
						</p>
			<div class="codr_unit_type">
			</div> </td>
	<td class="codr_unit_pricewrap">
                <div class="codr_unit_newprice notranslate">
    					<span class="blind">판매가격</span> <em class="ssg_price notranslate">1,280</em> <span class="ssg_tx">원</span>
    					</div>
                    <span class="codr_unit_line"></span>
    				<span class="codr_unit_count">
						<strong class="blind">상품수량</strong>
...
<div class="codr_payinfo v4">
		...
		<div class="codr_payinfo_inner">
			...
			<div class="codr_payinfo_cont codr_total">
				<div class="codr_payinfo_row ty_depth">
					...
					<div class="codr_payinfo_money"><em class="ssg_price notranslate">18,100</em><span class="ssg_tx">원</span>
					</div>
					<div class="codr_payinfo_row">
							<div class="codr_payinfo_tx codr_tx_point2">포인트사용</div>
							<div class="codr_payinfo_money codr_tx_point2">
								-<em class="ssg_price notranslate">1,000</em><span class="ssg_tx">원</span>
							</div>
						</div>
						<ul class="mnodr_paydetail_sublst">
								<li>
											<span class="mnodr_paydetail_tx">SSG MONEY</span>
											<span class="mnodr_paydetail_money"><em class="ssg_price">1,000</em><span class="ssg_tx">원</span></span>
										</li>
									</ul>
						</div>
				<div class="codr_payinfo_row ty_depth">
					<div class="codr_payinfo_tx">배송비</div>
					<span class="codr_payinfo_money">+<em class="ssg_price notranslate">3,000</em><span class="ssg_tx">원</span></span>
							</div>
				<div class="codr_payinfo_sum">
						<div class="codr_payinfo_tx">총 결제금액</div>
						<div class="codr_payinfo_money"><em class="ssg_price notranslate">20,100</em><span class="ssg_tx">원</span></div>
					</div>
				</div>
					...
					<div class="codr_payinfo_cont">
						<div class="codr_payinfo_row">
				                       	...
				                       	<div class="codr_payinfo_contxt">
				                       		<p>
												<input type="hidden" name="tgtPaymtId_0" value="1835792455_1835792455">
				                       			<span class="notranslate">카카오뱅크카드</span>
								                        &nbsp;5365-10**-****-****&nbsp;
								                        <br />
								                        일시불<br/>
							                        	</p>
				                       	...
				                       	<div class="codr_payinfo_block">
												<div class="payinfo_title">
													<span>SSG MONEY</span>
													<span>1,000 원</span></span>
												</div>
												<div class="payinfo_description">
													<span class="payinfo_description_text">충전머니 (기명식 선불전자지급수단) 사용:
														<span class="payinfo_description_price">1,000 원</span>
														<div class="payinfo_description_tooltip">
															<button class="codr_btn_tooltip codr-tooltip">
																<span class="codr_sp codr_ico_detail"><span class="blind">기명식 선불전자
																		지급수단 안내
																		상세보기</span></span>
															</button>
															<div class="codr_tooltip_cont">
																<div class="codr_tooltip_contents">
																	...
																	<div class="codr_tooltip_description">
																		<div class="codr_tooltip_description_main">
																			실지명의가 확인된 회원이 보유한 SSG MONEY의 충전머니는 기명식 선불전자지급수단이며, SSG MONEY 보유한도 (1회 사용가능금액)는 200만원입니다.
																		</div>
																		<div class="codr_tooltip_description_sub">
																			<p>기명식 선불전자지급수단은 조세특례제한법 126조의 2에 따라 현금영수증 발급이 불가하고
																				전자금융업자 (SSGPAY)가 연 1회 일괄 국세청에 제출합니다. (연말정산
																				간소화페이지에서 확인 가능)</p>
																			<p>단, 일부 카테고리 상품 구매 및 예치금 사용시
																				소득공제 자료에서 제외됩니다.</p>
																		</div>
	...
	<div class="codr_payinfo_sec">
			<div class="codr_payinfo_inner">
				<div class="codr_contit ty_underline">
					<h3 class="codr_contit_tx">구매혜택
						<span class="ssg_price codr_tx_point2">
								21</span><span class="ssg_tx codr_tx_point2">원</span><span class="blind">할인</span>
						</h3>
				</div>
				...
				<div class="codr_payinfo_cont codr_benefit">
						<div class="codr_payinfo_row">
									...
									<div class="codr_payinfo_money"><strong><em>21</em><span class="ssg_point">P</span></strong> </div>
								</div>
							</div>
			</div>
		</div>
...
<div class="mnodr_tooltip_bubble" id="benefitInfoDialog" role="dialog" tabindex="-1" aria-hidden="true" style="display: none; transform: translate(0px, 0px);">
	<div class="mnodr_tooltip_content">
		<p class="mnodr_tooltip_text"> 스마일클럽을 위한 SSG MONEY는 배송완료 시, 상품당 최대 1만원, 최대 5만원 한도로 지급됩니다. (단, 스마일클럽 이벤트로 적립되는 적립금은 멤버십 적립한도와 별개로 운영됩니다.)</p>
		<div class="mnodr_tooltip_append">
			<button type="button" class="mnodr_tooltip_btn_close js-btn-tooltip-close">
          <span class="mnodr_btn_content">
            <i class="icon ty_xs icon_close" aria-hidden="true"></i>
          </span>
			</button>
		</div>
	</div>
...
<div class="codr_btnarea ty_full">
								<ul>
										<li><button type="button" class="codr_btn codr_btn_blk"
												name="btnDigitalReceipt"
												data-orord-no="2024041502F004">
												<span>전자영수증</span>
											</button></li>
										<li><button type="button" class="codr_btn codr_btn_gray"
													name="btnCreditcardReceipt"
													data-orord-no="2024041502F004">
													<span>신용카드전표</span>
												</button></li>
										</ul>
								<p class="codr_btnarea_desc">기명식 선불전자지급수단(SSG MONEY)을 사용한 경우, 전자금융업자(SSGPAY)가 국세청에 연 1회 일괄 제출하여 소득공제 처리되며, <span class="codr_btnarea_desc_highlight">별도로 현금영수증은 발급되지 않습니다.</span></p>
								</div>
						</div>
				</div>
			</div>
<div class="ssg-layer-popup codr_lypop mnodr_lypop_tradein" id="mnodr_lypop_tradein"></div>
...
<div id="sellerInfoLayer" class="codr_lypop ty_line codr_sellerinfo_lypop" style="width: 325px; cursor: default;" role="dialog" aria-hidden="true">
</div>
...
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/pay/js/pay/lib/kakao.min.js?dummy=20240508"></script>
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/jquery.form.js"></script>
...
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.translate.js?v=202405070135"></script>
...
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.layerpopup.js?v=20240507"></script>
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/pay/js/pay/common/payLogUtil.js?dummy=20240508"></script>
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/pay/js/pay/myssg/CommonOrderInfo.js?v=202405070135"></script>
<input type="hidden" id="talkDomain" value="talk.ssg.com"/>
        <script type="text/javascript" src="https://sui.ssgcdn.com/ui/pay/js/pay/common/payComm.js?v=202405070135"></script>
        <script type="text/javascript" src="https://sui.ssgcdn.com/ui/pay/js/pay/myssg/OrderInfo.js?v=202405070135"></script>
        <script type="text/javascript">
			...
			.load(
					function() {
						...
						if ($("#selectClaim").val() == 'purchDcsnConfirm') {
							$(
							"button[name=btnPurchDcsnConfirmPage][data-ord-no="+$("#selectedOrdNo").val()+"]")
							.eq(0).trigger("click");
						}
					});
</script>
...
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.layerpopup.js?v=20240507"></script>
    <script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/common/ssgNavi.js?v=20240507"></script>
    <script>
$(function(){
...
<script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.layerpopup.js?v=20240507"></script>
	<script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.calendar_v2.js?v=20240507"></script>
	<script type="text/javascript" src="https://sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.order_v2.js?v=20240507"></script>
</div>
