...
<script type="text/javascript" async="" src="https://linkback.contentsfeed.com/src/20240509/lb4ssg.min.js" charset="utf-8"></script>
    ...
    <!-- mShareClipMeta -->
	<meta property="og:url" content="https://event.ssg.com/eventDetail.ssg?nevntId=1000000013320&amp;domainSiteNo=6005">
<meta property="og:image" content="https://sstatic.ssgcdn.com/promo/event/ssg/202405/45708885615997366.jpg">
...
<meta name="twitter:image" content="https://sstatic.ssgcdn.com/promo/event/ssg/202405/45708885615997366.jpg">
<!-- //mShareClipMeta -->
...
.TKXFYjyTT7BRVXk2l6uF a {
  ...
  </style><script src="https://www.mediacategory.com/script/common/media/0"></script></head>
...
<div id="content" class="content_primary content_event" style="min-height: 1100px;">
    ...
    <div class="cevent_top">
        <div class="cevent_inner cevent_inner_heading v2">
            ...
            <div class="cevent_date">
                ...
                <span class="cevent_data_term">2024.05.07 ~ 2024.05.15</span>
            ...
            <div class="alg_right">
                <ul class="cm_sns">
        <li><a href="javascript:void(0)" onclick="facebook_share_new('\uBF40\uC211 \uBC18\uB824\uB3D9\uBB3C \uD0C8\uCDE8\uC81C \uCCB4\uD5D8\uB2E8','[SSG.COM]','https://sstatic.ssgcdn.com/promo/event/ssg/202405/45708885615997366.jpg','','https://event.ssg.com/eventDetail.ssg?nevntId=1000000013320','EVENT')" class="facebook" title="페이스북"><span class="blind">페이스북</span></a></li>
        <li><a href="javascript:void(0)" onclick="twitter_share_new('[SSG.COM]','\uBF40\uC211 \uBC18\uB824\uB3D9\uBB3C \uD0C8\uCDE8\uC81C \uCCB4\uD5D8\uB2E8','','https://event.ssg.com/eventDetail.ssg?nevntId=1000000013320','EVENT')" class="twitter" title="트위터"><span class="blind">트위터</span></a></li>
        </ul>
    <div class="cm_clip cm_clip_planshop">
					<span class="cmlike _js_cmlike interestIt">
				     	...
				     	<input type="hidden" name="attnTgtIdnfNo1" value="1000000013320">
				     	<input type="hidden" name="attnTgtIdnfNo2" value="">
				     	<input type="hidden" name="notiTitle" value="뽀숑 반려동물 탈취제 체험단">
    ...
    <img alt="1" src="https://sstatic.ssgcdn.com/promo/html/pc/202405/2024050315573990746214565621_6.jpg" style="width: 632px; height: 32767px;"></div>
    ...
    <dl class="cevent_info" role="presentation">
        ...
        <dd class="cevent_info_cont">
            ...
            <ul class="cevent_inp_lst ty_block" role="group" aria-labelledby="selsamples" id="prvd_list">
                <li data-nevnt-prvd-id="1000000009423">
								<span class="cevent_rdo">
									<input type="radio" id="tester_bnf_1" name="tester_bnf" value="1000000009423">
            ...
            <div class="cevent_info_tbl ty_terms">
                <table>
                    ...
                    <tr>
                        <td>
                            <p class="cevent_terms_txt">[체험단] 이벤트 서비스는 [세제몰]에서 주관 운영합니다.<br>
본 이벤트에 응모하시는 경우 ‘회원 아이디, 성함, 이메일 주소, 휴대폰 번호, 기본주소’가 [세제몰]에 제공되며,<br>
...
단, 해당 동의 거부 시 이벤트 참여를 하실 수 없습니다.</p>
                        ...
                        <td>
                            <p class="cevent_terms_txt">[체험단] 이벤트 서비스는 [세제몰] 주관으로 운영됩니다.<br>
본 이벤트의 당첨자 선정 및 경품 발송 등 진행에 관련된 권한과 책임은 [세제몰]에 있으며, SSG.COM은 진행 및 당첨자 선정에 관여하지 않습니다.<br>
...
주소 입력 오류 등의 고객 실수로 오발송 되는 경품은 재발송이 불가합니다.</p>
            ...
            <div class="cevent_terms_notice">
                    안내 및 유의사항<br>
                    &nbsp;<span data-sheets-root="1" data-sheets-userformat="{" 2":12865,"3":{"1":0},"9":0,"12":0,"15":"malgun="" gothic","16":9}"="" data-sheets-value="{" 1":2,"2":"＊응모하시기="" 전,="" 아래의="" 개인정보="" 제공="" 및="" 운영방침에="" 대하여="" 확인="" 후="" 동의해주시기="" 바랍니다."}"="" style="color: rgb(0, 0, 0); font-size: 9pt; font-family: " malgun="" gothic";"="">＊응모하시기 전, 아래의 개인정보 제공 및 운영방침에 대하여 확인 후 동의해주시기 바랍니다.</span></div>
            </dd>
    </dl>
</div>
...
<div class="cevent_sec">
    ...
    <tr>
            ...
            <td class="cevent_writter">홍*정</td>
    ...
    <tr>
            ...
            <td>
		    	<span class="cevent_comment_txt">
			    	주요 베이스 원료 EWG 그린 등급으로 엄선된 원료, 취향별 4가지 향으로 은은하고 산뜻하게, 1회 분사만으로 배변냄새 94.4% 강력탈취, 실속있는 구성 다양한 용량까지 뽀숑 반려동물 탈취제 꼭 체험해보고싶어용</span>
            </td>
            <td class="cevent_writter">최*민</td>
            <td class="date">2024-05-09</td>
        </tr>
    <tr>
            <td>650</td>
            ...
            <td class="cevent_writter">김*연</td>
            <td class="date">2024-05-09</td>
        </tr>
    <tr>
            <td>649</td>
            ...
            <td class="cevent_writter">신*화</td>
            <td class="date">2024-05-09</td>
        </tr>
    <tr>
            <td>648</td>
            <td>
		    	<span class="cevent_comment_txt">
			    	여름이 다가와서 꼭 써보고 싶어요</span>
            </td>
            <td class="cevent_writter">임*영</td>
            <td class="date">2024-05-09</td>
        </tr>
    <tr>
            <td>647</td>
            ...
            <td class="cevent_writter">이*훈</td>
            <td class="date">2024-05-09</td>
        </tr>
    <tr>
            <td>646</td>
            ...
            <td class="cevent_writter">문*화</td>
            <td class="date">2024-05-09</td>
        </tr>
    <tr>
            <td>645</td>
            ...
            <td class="cevent_writter">최*주</td>
            <td class="date">2024-05-09</td>
        </tr>
    <tr>
            <td>644</td>
            <td>
		    	<span class="cevent_comment_txt">
			    	반려동물의  꿉꿉하고 쉰내를 뽀숑 반려동물 탈취제로 순환하고 싶어 신청합니다</span>
            </td>
            <td class="cevent_writter">이*은</td>
            <td class="date">2024-05-09</td>
        </tr>
    <tr>
            <td>643</td>
            ...
            <td class="cevent_writter">이*윤</td>
            <td class="date">2024-05-09</td>
        </tr>
    </tbody>
</table>
...
<span id="transObserver" class="blind" style="position:fixed;top:0px;display:none" data-default-txt="언어 번역">언어 번역</span>
...
<script type="text/javascript" id="">var linkback=linkback||{};(function(){var a=document,b=a.createElement("script");a=a.getElementsByTagName("head")[0];b.type="text/javascript";b.async=!0;var c=new Date;c=c.getFullYear().toString()+("0"+(c.getMonth()+1)).slice(-2)+("0"+c.getDate()).slice(-2);b.src="https://linkback.contentsfeed.com/src/"+c+"/lb4ssg.min.js";b.charset="utf-8";linkback.l||(linkback.l=!0,a.insertBefore(b,a.firstChild))})();</script><script type="text/javascript" id="">var checkLbLoaded=function(){linkback.send&&callLbInf()},lbItvFn=setInterval(checkLbLoaded,500),callLbInf=function(){linkback.send("inflow");linkback.track("inflow");clearInterval(lbItvFn)};</script><script type="text/javascript" id="" src="https://cdn.onetag.co.kr/0/tcs.js?eid=ubon3jnb3o11ubon3jnb3o"></script><script>
 ...
 </script><iframe allow="join-ad-interest-group" data-tagging-id="G-E0P8DK53C8" data-load-time="1715213666937" height="0" width="0" src="https://td.doubleclick.net/td/ga/rul?tid=G-E0P8DK53C8&amp;gacid=226516073.1711985933&amp;gtm=45je4510v897564458z8856866794za200&amp;dma=0&amp;gcd=13l3l3l3l1&amp;npa=0&amp;pscdl=noapi&amp;aip=1&amp;fledge=1&amp;frm=0&amp;z=1166469090" style="display: none; visibility: hidden;"></iframe><script>
var subdomain = window.location.hostname.split('.')[0];
