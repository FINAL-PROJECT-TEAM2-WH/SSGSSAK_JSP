...
<script async="" src="https://cdn.datamanager.co.kr/0/tcsdm.js?eid=ubon3jnb3o11ubon3jnb3o"></script><script src="https://www.mediacategory.com/script/common/media/0"></script><script src="https://www.mediacategory.com/script/common/media/0"></script></head>
            ...
            <div class="ssg_gnb_util">
                ...
                <div class="gnb_renew_util" data-react-tarea-cd="00042_000000090">
                    ...
                    <ul class="gnb_util" id="util_right">
                        <li id="gnbUserInfoArea" class="gnb_tx_user notranslate gnbUserInfoArea" style=""><a href="https://www.ssg.com/myssg/main.ssg?gnb=myssg"></a></li>
...
<div id="content" class="codr_ct_step3">
	...
	<div class="codr_wrap" id="divOrdArea">
		...
		<div id="_codr_sticky" class="codr_cont codr_sticky" style="min-height: 542px;">
				...
				<div class="codr_fixed" style="margin-left: 0px;">
					<div id="_codr_opt_bar" class="codr_opt_bar">
						<div class="codr_opt_wrap">
							...
							<div class="codr_opt_cont codr_scroll" style="max-height: 661px;">
		...
		<div class="codr_acdo_cont">
				...
				<div class="codr_sec">
							...
							<dl class="codr_dl" aria-hidden="false" role="none presentation">
								...
								<dd class="codr_dd">
									<div class="codr_pay_box">
										<input type="hidden" id="deliShppMemoInput_0" name="shpploc[0].deliShppMemo" value="문 앞에 놔주세요" class="saveOrdUserDefiMemo deliShppMemo payTracking" data-pt-click="PC개편주문서|배송메시지|택배배송메시지선택">
										...
										<span class="codr_pay_drop">
											...
											</select><div class="codr_drop">   <div class="codr_drop_area">    <button type="button" class="codr_drop_select _drop_select" aria-haspopup="listbox">              <span class="codr_drop_txt ">문 앞에 놔주세요         </span></button>    <div class="codr_drop_scroll">     <div class="codr_scroll">      <ul class="codr_drop_list _drop_list" role="listbox" aria-activedescendant="drop_select" tabindex="-1">                                      <li data-index="0" role="option" aria-selected="false">            <button type="button" class="codr_drop_btn">                        <span class="codr_drop_txt ">배송기사에게 전달되는 메시지 입니다. 선택해 주세요.                              </span></button>                      </li>                                             <li data-index="1" role="option" aria-selected="false">            <button type="button" class="codr_drop_btn">                        <span class="codr_drop_txt ">부재 시 경비실에 맡겨주세요                              </span></button>                      </li>                                             <li data-index="2" role="option" aria-selected="false">            <button type="button" class="codr_drop_btn">                        <span class="codr_drop_txt ">부재 시 문앞에 놓아주세요                              </span></button>                      </li>                                             <li data-index="3" role="option" aria-selected="false">            <button type="button" class="codr_drop_btn">                        <span class="codr_drop_txt ">직접 받겠습니다                              </span></button>                      </li>                                             <li data-index="4" role="option" aria-selected="false">            <button type="button" class="codr_drop_btn">                        <span class="codr_drop_txt ">배송전에 연락주세요                              </span></button>                      </li>                                             <li data-index="5" role="option" aria-selected="false">            <button type="button" class="codr_drop_btn">                        <span class="codr_drop_txt ">직접 입력                              </span></button>                      </li>                                           <li class="selected" data-index="6" role="option" aria-selected="true">           <button type="button" class="codr_drop_btn">                            <span class="codr_drop_txt ">문 앞에 놔주세요                    </span></button>                  </li>                                 </ul>     </div>    </div>   </div>  </div>
										</span>
    ...
    <i class="mncasamia"><span class="blind">까사미아</span></i>
																...
																<td class="codr_unit_dc">
																	...
																	<span class="codr_pay_drop readonly">
																		<select id="secItemProm_1" name="secItemPromApl[0]" data-offer-apl-key="" data-userselected="" data-template="#_dropdown" class="_dropdown secItemPromApl" title="상품쿠폰 선택" onchange="PayCustomEvent.changeSecItemCpn(event, this);return false;" style="display:none" readonly="">
																		...
																		</select><div class="codr_drop">   <div class="codr_drop_area">    <button type="button" class="codr_drop_select _drop_select" aria-haspopup="listbox"><span class="codr_drop_txt ">적용가능한 상품쿠폰이 없습니다.</span></button>    <div class="codr_drop_scroll">     <div class="codr_scroll">      <ul class="codr_drop_list _drop_list" role="listbox" aria-activedescendant="drop_select" tabindex="-1"><li class="selected" data-index="0" role="option" aria-selected="true">           <button type="button" class="codr_drop_btn">                            <span class="codr_drop_txt ">적용가능한 상품쿠폰이 없습니다.                    </span></button>                  </li></ul>     </div>    </div>   </div>  </div>
																	</span>
																</td>
																
																	<td class="codr_unit_cpn" rowspan="1">
																		<span class="codr_pay_drop">
																			<select id="secOrdPromApl" name="secOrdPromApl" data-template="#_dropdown" class="_dropdown" title="장바구니쿠폰 선택" onchange="PayCustomEvent.changeSecOrdCpn(event, this);return false;" style="display:none" readonly="">
																				
																					
																					
																						<option value="" disabled="disabled">적용가능한 장바구니쿠폰 없음</option>
																					
																				
																			</select><div class="codr_drop">   <div class="codr_drop_area">    <button type="button" class="codr_drop_select _drop_select" aria-haspopup="listbox"><span class="codr_drop_txt ">적용가능한 장바구니쿠폰 없음</span></button>    <div class="codr_drop_scroll">     <div class="codr_scroll">      <ul class="codr_drop_list _drop_list" role="listbox" aria-activedescendant="drop_select" tabindex="-1"><li class="selected" data-index="0" role="option" aria-selected="true">           <button type="button" class="codr_drop_btn">                            <span class="codr_drop_txt ">적용가능한 장바구니쿠폰 없음                    </span></button>                  </li></ul>     </div>    </div>   </div>  </div>
																		</span>
																	</td>
							...
							<!-- SSGPAY(s) -->
								...
								<div class="cpay_acdo cpay_acdo_toggle on">
									...
									<div class="cpay_acdo_cont" id="_cpay_ssgpay_cont" aria-labelledby="_cpay_ssgpay_toggle">
										<!-- SSGPAY: 사용가능(s) -->
										<div class="cpay_card_slider swiper_box_wrapper ssgpayWebExpDiv ssgpayWebExpDiv_0000 ssgpayWebExpDiv_1002 ssgpayWebExpDiv_1012" id="_cpay_ssgpay_slider" style="">
										...
										<div class="cpay_error_bx ssgpayWebExpDiv ssgpayWebExpDiv_9999" style="display:none;">
											<div class="cpay_error_msg">
							...
							<!-- SSGPAY 계좌결제(s) -->
								...
								<div class="cpay_acdo cpay_acdo_toggle ty_account">
									...
									<div class="cpay_acdo_cont" id="_cpay_ssgpay_account_cont" aria-labelledby="_cpay_ssgpay_account_toggle">
										<!-- SSGPAY: 사용가능(s) -->
										<div class="cpay_card_slider swiper_box_wrapper ssgpayWebExpDiv ssgpayWebExpDiv_0000 ssgpayWebExpDiv_1002 ssgpayWebExpDiv_1012 ssgpayWebExpDiv_2202" id="_cpay_ssgpay_account_slider" style="">
											<div class="cpay_card_control">
